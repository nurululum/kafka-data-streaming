...
consumer = Consumer({'bootstrap.servers': 'url-kafka', 'security.protocol': 'SASL_SSL', 'sasl.mechanisms': 'PLAIN', 'sasl.username': 'username-kafka', 'sasl.password': 'password-kafka', 'group.id': 'python_example_group_1', 'auto.offset.reset': 'earliest'})
# Set up a callback to handle the '--reset' flag.

# Subscribe to topic
consumer.subscribe(['nurul-data-clean'])
div = Div(
    text='',
    width=120,
    height=35
